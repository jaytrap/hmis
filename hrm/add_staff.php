            ...
            <div class="page-header page-header-default">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">HRM</span> - Create Staff</h4>
                    </div>
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="icon-user position-left"></i> HRM</a></li>
                    ...
                    <ul class="breadcrumb-elements">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li><a href="#"><i class="icon-statistics"></i> My Profile</a></li>
                                <li><a href="#"><i class="icon-accessibility"></i> Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
